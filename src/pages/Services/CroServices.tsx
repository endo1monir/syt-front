                    ...
                    <div className="services-hero__container">
                        ...
                        <div className="services-hero__content">
                            ...
                            <p className="services-hero__description">
                                في صيت نشتغل على تحويل كل زيارة لفرصة بيع حقيقية ، لأننا ندرس تجربة العميل من أوّل ما يدخل الموقع، لين يوصل لصفحة الدفع.
                                نحلل كل نقطة ممكن توقفه أو تشتّته ونعالجها. لأننا نؤمن إن البساطة هي السر، نخلي كل شي واضح وسهل. ونجرّب أكثر من تصميم ونختار الأفضل.
                                حتى المحتوى؟ نطوّره باستمرار عشان يتكلم بلغة عملاءك، ويشرح لهم الفوايد بطريقة تقنعهم. هدفنا؟ نرفع مبيعاتك… بدون ما نرفع ميزانيتك التسويقية
                            </p>
